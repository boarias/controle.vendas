...
// ... conteúdo atualizado com botão de exportação
...
export default function ControleDeVendas() {
  ...
  const exportarRelatorio = () => {
    const cabecalho = [
      "Data de Emissão", "Localizador", "Titular", "Valor Utilizado", "Deságio (%)", "Quem Emitiu", "Lucro"
    ];
    ...
    link.href = url;
    link.setAttribute("download", "relatorio_vendas.tsv");
    ...
    <div className="p-4 grid gap-4 max-w-3xl mx-auto">
      <Card>
        <CardContent className="grid gap-4 p-4">
          ...
          <Button variant="outline" onClick={exportarRelatorio}>Exportar Relatório</Button>
        </CardContent>
      </Card>
